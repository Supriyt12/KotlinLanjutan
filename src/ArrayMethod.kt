fun main(args: Array<String>) {
    ...
    val simpsonsA = arrayOf("Home" , "Marge", "Bart", "Lisa", "Meggie")
    simpsonsA.sort ()
    ...
    // sorted()
    val simponsB: Array<String> = arrayOf("Homer", "Marge", "Bart", "Lisa", "Meggie")
    ...
    if (position != -1) {
        println("Yeah, that's my number ${position + 1} Simpson1")
